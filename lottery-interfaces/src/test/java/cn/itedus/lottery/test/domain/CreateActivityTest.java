...
public class CreateActivityTest {
    ...
    public void create_activity(){
        ActivityConfigReq req = new ActivityConfigReq(activityId,activityConfigRich);
