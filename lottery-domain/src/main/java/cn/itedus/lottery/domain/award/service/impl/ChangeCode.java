...
public class ChangeCode extends DistributionBase implements GiveAward {
    @Override
    public GiveAwardResult doGiveAward(GiveAwardRequest giveAwardRequest) {
        // 模拟调用兑换码
        logger.info("模拟调用兑换码 uId：{} awardContent：{}", giveAwardRequest.getuId(), giveAwardRequest.getAwardContent());
