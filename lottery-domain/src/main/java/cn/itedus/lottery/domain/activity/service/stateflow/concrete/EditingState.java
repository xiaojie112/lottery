...
public class EditingState extends AbstractState {
    ...
    public Result arraignment(Long activityId, Enum<Constants.ActivityState> currentState) {
        boolean isSuccess = activityRepository.alterActivityStatus(activityId, currentState, Constants.ActivityState.ARRAIGNMENT);
    ...
    public Result close(Long activityId, Enum<Constants.ActivityState> currentState) {
        boolean isSuccess = activityRepository.alterActivityStatus(activityId, currentState, Constants.ActivityState.CLOSE);
